...
case 1:
	...
	private void generateInOverWorld(World world, Random random, int x, int z) {
		for (int i = 0; i < 100; i++){ //ta petadvacitka je jak to je vzacny
			int chunkX = x + random.nextInt(16);
			int chunkY =random.nextInt(20);
			int chunkZ = z + random.nextInt(16);
			new WorldGenMinable(ModItems.copperore.getDefaultState(), 4).generate(world, random, new BlockPos(chunkX,chunkY,chunkZ));
		}
	}
